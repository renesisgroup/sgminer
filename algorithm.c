...
static cl_int queue_renesis_kernel(struct __clState *clState, struct _dev_blk_ctx *blk, __maybe_unused cl_uint threads)
{
  cl_kernel *kernel;
  unsigned int num;
  cl_ulong le_target;
...
#define A_DARK(a, b) \
  ...
  A_DARK("renesis", renesis_regenhash),
...
#undef A_DARK
  ...
  { "renesis", ALGO_RENESIS, "", 1, 1, 1, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 7, 8 * 16 * 4194304, 0, renesis_regenhash, NULL, NULL, queue_renesis_kernel, gen_hash, append_x11_compiler_options },
